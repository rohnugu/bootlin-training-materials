...
\begin{frame}{Booting on STM32MP1: datasheet}
  \begin{columns}
    \column{0.7\textwidth}
    \begin{center}
      \includegraphics[height=0.7\textheight]{slides/sysdev-bootloaders-sequence/stm32mp1-rom-code.png}
    \end{center}
    \column{0.3\textwidth}
    {\tiny
...
\begin{frame}{Booting on AM335x (32 bit BeagleBone): datasheet}
  \begin{columns}[T]
      \column{0.6\textwidth}
      \begin{center}
        \includegraphics[height=0.7\textheight]{slides/sysdev-bootloaders-sequence/am335x-rom-code.png}
      \end{center}
      \column{0.4\textwidth}
      {\tiny
        Source:\\
